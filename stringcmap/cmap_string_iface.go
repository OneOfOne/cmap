...
// cmd: genx -pkg github.com/OneOfOne/cmap -n stringcmap -t KT=string -t VT=interface{} -fld HashFn -fn DefaultKeyHasher -s cm.HashFn=hashers.Fnv32 -m -o ./stringcmap/cmap_string_iface.go
// +build !genx
